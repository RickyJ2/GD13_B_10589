package com.example.gd11_b_10589.adapters
...
import com.example.gd11_b_10589.AddEditActivity
import com.example.gd11_b_10589.MainActivity
import com.example.gd11_b_10589.R
import com.example.gd11_b_10589.models.Mahasiswa
import com.google.android.material.dialog.MaterialAlertDialogBuilder
import java.util.*


class MahasiswaAdapter (private var mahasiswaList: List<Mahasiswa>, context: Context): RecyclerView.Adapter<MahasiswaAdapter.ViewHolder>(),
    Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder{
        ...
        val view = infalter.inflate(R.layout.item_mahasiswa, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int){
        ...
        holder.tvFalkutas.text = mahasiswa.falkutas
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        init{
            ...
            tvFalkutas = itemView.findViewById(R.id.tv_falkutas)
